...
class Network(tf.keras.Model):
    ...
    def crf_loss(self, gold_labels, logits):
        ...
        likelihoods = tfa.text.crf_log_likelihood(inputs=logits.to_sparse(), tag_indices=gold_labels.to_sparse(
    ...
    def crf_decode(self, logits):
        ...
        predictions = tfa.text.crf_decode(logits.to_sparse())
        predictions = logits.from_sparse(predictions)
